  ...
  return (
    <>
      {!isLoading && events.length > 0 ? (
        ...
        <div className="relative h-screen max-h-screen min-h-[800px] w-full bg-[url(/homepage/boulder_1920.jpg)] bg-cover bg-no-repeat shadow-2xl shadow-amber-400/40"></div>
      )}
      <EventsSection
        events={events}
        filters={filters}
