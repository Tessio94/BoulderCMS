...
const GymContent = ({ gyms }) => {
  const t = useTranslations("Gym");

  return (
    <>
      <div className="relative z-0 flex h-screen min-h-[800px] sm:min-h-auto max-h-[calc(100vh-125px)] w-full items-center justify-center overflow-hidden bg-[url(/gyms/gyms_1024.jpg)] bg-no-repeat xl:block lg:bg-none">
        <Image
        ...
        <Image
          ...
          height={480}
        />
        <div className="flex xl:w-[900px] max-w-[90%] flex-col gap-8 rounded-2xl xl:gap-12 z-20  lg:left-[9%] absolute bottom-[28%]">
