...
const EventsLanding = ({ event }) => {
  ...
  return (
    <div className="relative flex h-screen min-h-[800px] w-full items-center justify-center pt-[125px] shadow-2xl shadow-amber-400/40 lg:min-h-fit">
      <Image
        ...
        sizes="100vw"
      />
      <div className="z-0 mt-10 mb-10 w-[800px] max-w-[90%] sm:w-[505px] sm:max-w-[72%] lg:w-[unset]">
